//package com.donsdirectory.mobile.helpers
//
...
//                    val emails = ArrayList<CommonDataKinds.Email>()
...
//                    val organization = CommonDataKinds.Organization("", "")
...
//    }
//
//    private fun getEmails(contactId: Int? = null): SparseArray<ArrayList<CommonDataKinds.Email>> {
//        val emails = SparseArray<ArrayList<CommonDataKinds.Email>>()
...
//                    }
//
//                    emails[id]!!.add(CommonDataKinds.Email(email, type, label))
//                } while (cursor.moveToNext())
//            }
//        } catch (e: Exception) {
//            context.showErrorToast(e)
...
//    }
//
//    private fun getOrganizations(contactId: Int? = null): SparseArray<CommonDataKinds.Organization> {
//        val organizations = SparseArray<CommonDataKinds.Organization>()
//        val uri = ContactsContract.Data.CONTENT_URI
//        val projection = arrayOf(
//                ContactsContract.Data.RAW_CONTACT_ID,
...
//                    }
//
//                    val organization = CommonDataKinds.Organization(company, title)
...
//                val thumbnailUri = cursor.getStringValue(CommonDataKinds.StructuredName.PHOTO_THUMBNAIL_URI) ?: ""
//                val organization = getOrganizations(id)[id] ?: CommonDataKinds.Organization("", "")
